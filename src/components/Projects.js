        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 mb-4">
          ...
          <div className="lg:col-span-9 space-y-4">
            {filteredProjects.map((project, index) => (
              <div key={index} className="border border-green-900 bg-black p-4">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
                  ...
                  {/* Project Stats */}
                  <div className="lg:col-span-4 text-xs space-y-2 mt-4 lg:mt-0">
                    <div className="flex justify-between">
                      <span>STATUS</span>
                      <span
                        className={`text-${project.stats.status === "LIVE" ? "green" : "yellow"}-500`}
                      >
                ...
                {/* Project Links */}
                <div className="mt-4 pt-4 border-t border-green-900/30 flex gap-4 items-center">
                  <a
